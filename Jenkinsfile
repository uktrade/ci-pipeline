                  ...
                  ansiColor('xterm') {
                    ...
                    if (cf_manifest_exist) {
                      ...
                      if (cf_manifest.applications.size() != 1) {
                        echo "\u001B[31mWARNING: CF V2 manifest.yml contains more than 1 application defined!\u001B[m"
                      } else if (cf_manifest.applications[0].size() != 1) {
                        echo "\u001B[31mWARNING: CF V2 manifest.yml contains more than 1 attribute for application defined!\u001B[m"
                      } else if (cf_manifest.applications[0].buildpack) {
                        env.PAAS_BUILDPACK = cf_manifest.applications[0].buildpack
                      } else {
                        echo "\u001B[31mWARNING: Invalid CF V2 manifest.yml ignored.\u001B[m"
                      }
                    }
