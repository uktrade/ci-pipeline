    ...
    stage('input') {
      steps {
        script {
          ...
          if (env.Team == null || env.Team.allWhitespace) {
            team = input(
          ...
          if (env.Project == null || env.Project.allWhitespace) {
            project = input(
          ...
          if (env.Environment == null || env.Environment.allWhitespace) {
            environment = input(
          ...
          if (env.Git_Commit == null || env.Git_Commit.allWhitespace) {
            git_commit = input(
